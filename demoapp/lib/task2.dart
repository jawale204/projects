...
// final ItemPositionsListener itemPositionsListener1 = ItemPositionsListener.create();
  var json = """
[
  ...
  changeposition(which, index) {
    print(_scrollController1.position.maxScrollExtent / problems.length);
    print(_scrollController2.position.maxScrollExtent / problems.length);
    if (which == 1) {
      _scrollController2.animateTo(
          ((_scrollController1.position.maxScrollExtent / problems.length) +
                  10) *
              index,
          curve: Curves.easeIn,
